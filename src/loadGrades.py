...
def loadGrades():
    ...
    with requests.Session() as s:
        ...
        p1 = s.get('https://www.studenti.unipi.it/auth/Logon.do')
        p2 = s.get(p1.url)
        ...
        browser.get('https://www.studenti.unipi.it/auth/Logon.do')
        ...
        browser.get('https://www.studenti.unipi.it/auth/studente/SceltaCarrieraStudente.do?stu_id=3333874')
        browser.get('https://www.studenti.unipi.it/auth/studente/Libretto/LibrettoHome.do?menu_opened_cod=menu_link-navbox_studenti_Carriera')
        print("DONE")
